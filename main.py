...
myLehrerkürzel = Button(inhalt, text="Lehrerkürzel", command=lambda: lehrerkürzel(0) , bg="#2d2d2d", fg="#e4bc1f", width=(rootWidth//2), height=rootHeight-10)

myLehrerkürzel.pack_forget()

myInformation = Button(inhalt, text="Über die Schule", command=über_die_Schule, bg="#2d2d2d", fg="#e4bc1f", width=(rootWidth//2), height=rootHeight-10)

myInformation.pack_forget()

myEvent = Button(inhalt, text="Event",command=event, bg="#2d2d2d",fg="#e4bc1f",width=(rootWidth//2),height=65)                             #Eventbutton wurde erstellt


myAusfall = Button(inhalt, text="Ausfall/Vertretung",command=ausfall, bg="#2d2d2d",fg="#e4bc1f",width=(rootWidth//2),height=roo)            #Ausfall/Vertretung Button wurde erstellt
